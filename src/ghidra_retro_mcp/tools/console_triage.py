...
def detect_nintendo_platform(rom_path: str) -> Tuple[str, str, str]:
    """
    Scans raw file header offsets to extract magic signatures.
    Returns: (Platform Name, Ghidra Language ID, Target Loader Name)
    """
    ...
    # 1. NES iNES Header Matching (Magic: 'NES\x1a')
    if header[0:4] == b"NES\x1a":
        return "Nintendo Entertainment System (NES)", "6502:LE:16:default", "iNES Loader"

    # 2. Game Boy Advance Cartridge Profile
    ...
    # 3. Nintendo DS Cartridge Layout Validation
